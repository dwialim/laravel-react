				...
				<nav className="navbar navbar-expand">
					...
					<div className="user-box dropdown">
						...
						<ul className="dropdown-menu dropdown-menu-end">
							<li><a className="dropdown-item" href="#" onClick={handleClick}><i className="bx bx-user"></i><span>Profile</span></a>
							</li>
							<li><a className="dropdown-item" href="#" onClick={handleClick}><i className="bx bx-cog"></i><span>Settings</span></a>
							</li>
							<li><a className="dropdown-item" href="#" onClick={handleClick}><i className='bx bx-home-circle'></i><span>Dashboard</span></a>
							</li>
							<li><a className="dropdown-item" href="#" onClick={handleClick}><i className='bx bx-dollar-circle'></i><span>Earnings</span></a>
							</li>
							<li><a className="dropdown-item" href="#" onClick={handleClick}><i className='bx bx-download'></i><span>Downloads</span></a>
							</li>
							<li>
								<div className="dropdown-divider mb-0"></div>
							</li>
							<li><a className="dropdown-item" href="#" onClick={handleClick}><i className='bx bx-log-out-circle'></i><span>Logout</span></a>
							</li>
						</ul>
					</div>
				</nav>
